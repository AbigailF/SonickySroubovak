...
set xlabel "vysi_roz"
plot [1.1:1.3] "test1.dat"      using 1:3 with lines lc rgbcolor "#00000f" #title "right channel"
set xlabel "vysi_roz"
plot [1.165:1.19] "test1.dat"      using 1:3 with lines lc rgbcolor "#ff000" #title "right channel"
unset multiplot